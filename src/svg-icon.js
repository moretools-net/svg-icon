 ...
 * svg-icon.js
 * version: 1.0
 * Licensed under MIT (https://github.com/moretools-net/svg-icon/blob/main/LICENSE)
 * --------------------------------------------------------------------------
 */
...
const svgIcon = (el) => {
    ...
    // if( /<\/?[a-z][a-z0-9-]*[\s\S]*>/i.test )
    const Placeholder = document.querySelectorAll(el + ':not(.svg-icon-rendered)');
